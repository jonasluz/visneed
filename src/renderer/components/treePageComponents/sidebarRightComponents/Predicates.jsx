            ...
            <table className='items-center table-auto text-left whitespace-nowrap text-sm h-full rounded-lg'>
                ...
                <tbody className='bg-background-green-400'>
                    {predicates.map((predicate, index) => {
                        // Ignora predicados com "No predicate"
                        if (predicate.predicate === "No predicate") return null;
                        ...
                        return (
                            <tr key={index} className='font-bold'>
                                ...
                                <td className='px-4 py-2'>{predicate.predicate.key}</td>
                                <td className='px-4 py-2'>{predicate.predicate.condition}</td>
                                <td className='px-4 py-2'>{predicate.predicate.value}</td>
                                <td className='px-4 py-2'>{predicate.predicate.logicalOperator}</td>
                            </tr>
                        );
                    })}
                </tbody>
